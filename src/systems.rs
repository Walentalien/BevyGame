...
use bevy::math::Vec3;
use bevy::prelude::{Camera2d, Commands, DetectChanges, EventReader, EventWriter, KeyCode, Query, Res, ResMut, Sprite, Time, Transform, Window, With};
use bevy::sprite::Anchor;
use bevy::window::PrimaryWindow;
use rand::{random, rng, Rng};
use crate::components::{Enemy, Player, Star};
use crate::{ENEMY_SIZE, ENEMY_SPEED, NUMBER_OF_ENEMIES, NUMBER_OF_STARS, PLAYER_SIZE, PLAYER_SPEED, STAR_SIZE};
